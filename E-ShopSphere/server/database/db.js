...
const Connection = async (username, password) => {
    ...
    // const URL = `mongodb://${username}:${password}@shopnest-shard-00-00.fdvft.mongodb.net:27017,shopnest-shard-00-01.fdvft.mongodb.net:27017,shopnest-shard-00-02.fdvft.mongodb.net:27017/SHOPNEST?ssl=true&replicaSet=atlas-ilaj5d-shard-0&authSource=admin&retryWrites=true&w=majority`;
