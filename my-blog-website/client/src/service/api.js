...
const createAPI = (serviceUrl) => (body, showUploadProgress, showDownloadProgress) =>
    axiosInstance({
        method: serviceUrl.method,
        url: serviceUrl.url,
        data: serviceUrl.method === 'DELETE' ? '' : body,
        responseType: serviceUrl.responseType,
        headers: {
            authorization: getAccessToken(),
        },
        TYPE: getType(serviceUrl, body),
